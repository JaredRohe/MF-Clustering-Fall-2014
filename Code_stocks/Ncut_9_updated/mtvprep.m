function  [MTVsol,purity,energy]=mtvprep( slidingwindow,numcluster,neighbors,weight,groundtruth)
%% Info
...
% print_every=1;
% 
% mtv( W, L , F_init , rel_tol, maxTime,max_iter,C,verbose, print_every);
%     



[MTVsol,purity,energy]=MTV_clustering(W,groundtruth,numcluster);
...
% % % mtv prints to screen so no returned output.  thats why the following
% is commented. 
