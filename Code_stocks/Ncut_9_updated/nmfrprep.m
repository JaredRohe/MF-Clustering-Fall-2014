function C=nmfrprep( slidingwindow,numcluster,alg,neighbors)
%% Info
...
candidadte_alphas= [linspace(0.1,0.9,9),0.99];
max_iter=10000;
check_step=1000;
verbose

C = nmfr_auto(W, numcluster, candidate_alphas, max_iter, check_step, verbose, W0, nSeed,C_grnd_truth,K,print_every);
