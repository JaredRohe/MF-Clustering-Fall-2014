function [clusterid,NcutDiscrete,NcutEigenvectors,NcutEigenvalues,Q,W,modules] = ncutprep(slidingwindow,numcluster,neighbors,weight)
...
modules=cell(1,numcluster);
for i =1:numcluster
        modules{i}=find(clusterid==i)';



end

Q=modularity_metric(modules,W);
